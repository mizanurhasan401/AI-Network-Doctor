...
const en = {
  ...
  'results.routerBrand': 'Router brand (detected)',
  ...
  // Router access
  'router.title': 'Router access',
  'router.subtitle': 'Log into your router (same network) to read its info — read-only + reboot.',
  'router.credentials': 'Router login',
  'router.vendor': 'Brand',
  'router.vendor.tplink': 'TP-Link',
  'router.vendor.tenda': 'Tenda',
  'router.vendor.mikrotik': 'MikroTik',
  'router.vendor.huawei': 'Huawei',
  'router.vendor.zte': 'ZTE',
  'router.host': 'Router IP (gateway)',
  'router.username': 'Username',
  'router.password': 'Password',
  'router.securityNote': 'Credentials are used only for this request and never saved to disk.',
  'router.tplinkNote': 'TP-Link support targets the classic web UI; very new Archer firmware may not be supported yet.',
  'router.fetchButton': 'Fetch router info',
  'router.fetching': 'Connecting…',
  'router.rebootButton': 'Reboot router',
  'router.rebootConfirm': 'Click again to confirm reboot',
  'router.rebooting': 'Rebooting…',
  'router.fetchFailed': 'Could not read router',
  'router.rebootDone': 'Reboot command sent.',
  'router.rebootFailed': 'Reboot failed',
  'router.deviceInfo': 'Device info',
  'router.model': 'Model',
  'router.firmware': 'Firmware',
  'router.wanStatus': 'WAN / Internet status',
  'router.connected': 'Connected',
  'router.wanIp': 'WAN IP',
  'router.connectionType': 'Connection type',
...
const bn: Record<MessageKey, string> = {
  ...
  'results.routerBrand': 'রাউটার ব্র্যান্ড (শনাক্ত)',
  ...
  // Router access
  'router.title': 'রাউটার অ্যাক্সেস',
  'router.subtitle': 'একই নেটওয়ার্কে থেকে রাউটারে লগইন করে তথ্য দেখুন — read-only + reboot।',
  'router.credentials': 'রাউটার লগইন',
  'router.vendor': 'ব্র্যান্ড',
  'router.vendor.tplink': 'TP-Link',
  'router.vendor.tenda': 'Tenda',
  'router.vendor.mikrotik': 'MikroTik',
  'router.vendor.huawei': 'Huawei',
  'router.vendor.zte': 'ZTE',
  'router.host': 'রাউটার IP (gateway)',
  'router.username': 'ইউজারনেম',
  'router.password': 'পাসওয়ার্ড',
  'router.securityNote': 'লগইন তথ্য শুধু এই অনুরোধে ব্যবহার হয় — কখনো ডিস্কে সেভ হয় না।',
  'router.tplinkNote': 'TP-Link সাপোর্ট ক্লাসিক ওয়েব UI-এর জন্য; খুব নতুন Archer ফার্মওয়্যার এখনো নাও চলতে পারে।',
  'router.fetchButton': 'রাউটার তথ্য আনুন',
  'router.fetching': 'সংযোগ হচ্ছে…',
  'router.rebootButton': 'রাউটার রিবুট',
  'router.rebootConfirm': 'নিশ্চিত করতে আবার ক্লিক করুন',
  'router.rebooting': 'রিবুট হচ্ছে…',
  'router.fetchFailed': 'রাউটার পড়া যায়নি',
  'router.rebootDone': 'রিবুট কমান্ড পাঠানো হয়েছে।',
  'router.rebootFailed': 'রিবুট ব্যর্থ',
  'router.deviceInfo': 'ডিভাইস তথ্য',
  'router.model': 'মডেল',
  'router.firmware': 'ফার্মওয়্যার',
  'router.wanStatus': 'WAN / ইন্টারনেট স্ট্যাটাস',
  'router.connected': 'সংযুক্ত',
  'router.wanIp': 'WAN IP',
